...
class Note(pygame.sprite.Sprite):
    ...
    def found(self):
        #remove from all_sprites ##i really should make like a sprites manager create, add and remove to from group if next and x is True next += 1 x and false when inside
